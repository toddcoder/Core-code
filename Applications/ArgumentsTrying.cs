...
public class ArgumentsTrying
{
   ...
   public Optional<Unit> AssertMinimumCount(int minimumCount)
   {
   ...
   public Optional<Unit> AssertMaximumCount(int maximumCount)
   {
