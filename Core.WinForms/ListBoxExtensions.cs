...
public static class ListBoxExtensions
{
   ...
   public static Optional<string> SelectedText(this ListBox listBox)
   {
      var index = listBox.SelectedIndex;
      return maybe<string>() & index > -1 & (() => listBox.Items[index].ToNonNullString());
   }

   public static Optional<int> SelectedIndex(this ListBox listBox)
   {
      var index = listBox.SelectedIndex;
      return maybe<int>() & index > -1 & index;
   }

   public static Optional<(string text, int index)> SelectedTextWithIndex(this ListBox listBox)
   {
      var index = listBox.SelectedIndex;
